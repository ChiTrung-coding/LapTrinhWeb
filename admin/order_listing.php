    ...
    <div class="listing-items">
        ...
        <form id="<?=$config_name?>-search-form" action="<?=$config_name?>_listing.php?action=search" method="POST">
                <fieldset>
                    ...
                    Mã <?=$config_title?>: <input type="text" name="madonhang" value="<?=!empty($madonhang)?$madonhang:""?>" />
        ...
        <ul>
            <li class="listing-item-heading">
                <div class="listing-prop listing-id">Mã</div>
            ...
            <li>
                <div class="listing-prop listing-id"><?=$row['madonhang']?></div>
